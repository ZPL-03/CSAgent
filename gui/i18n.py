...
TEXT: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "chat.empty.tool_title": "工具调用 · abaqus_solver",
        "chat.empty.tool_body": "有限元阶段会显示正式 C 编号、作业状态、线性屈曲、Static Riks 后屈曲、云图路径和诊断摘要。",
        "chat.empty.evidence_a": "RAG/KG 证据",
        "chat.empty.evidence_b": "候选来源审计",
        "button.start": "发送",
        "button.confirm": "确认继续",
        "button.pause": "跳过/暂停",
        ...
        "candidate.empty_body": "完成任务解析和候选生成后，这里显示候选来源、代理预测、面密度、评分、FEM 状态和结论。",
    ...
    "en": {
        ...
        "chat.empty.tool_title": "Tool Call · abaqus_solver",
        "chat.empty.tool_body": "The FEM stage displays the formal C identifier, job state, linear buckling, Static Riks postbuckling, cloud-map path, and diagnostic summary.",
        "chat.empty.evidence_a": "RAG/KG Evidence",
        "chat.empty.evidence_b": "Candidate Source Audit",
        "button.start": "Send",
        ...
        "candidate.empty_body": "After task parsing and candidate generation, this panel shows source, surrogate prediction, areal density, score, FEM status, and verdict.",
